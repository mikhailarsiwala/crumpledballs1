class DustBin{
    ...
    display(){
        ...
        rect(this.bodyb.position.x-(this.bodyb.width/2)), this.bodyb.position.y-(this.bodyb.height*(2*(this.bodyb.width/100))) , this.bodyb.height,this.bbodyb.width/2
         rect(this.bodyb.position.x+(thisbodyb.width/2)), this.bodyb.position.y-(this.bodyb.height*(2*(this.bodyb.width/100))) , this.bodyb.height,this.bbodyb.width/2
    }
}